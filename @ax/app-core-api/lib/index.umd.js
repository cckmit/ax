(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@ax/app-core-framework'), require('axios')) :
  typeof define === 'function' && define.amd ? define(['exports', '@ax/app-core-framework', 'axios'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.AxApi = {}, global.appCoreFramework, global.axios));
}(this, (function (exports, appCoreFramework, axios) { 'use strict';
  ...
  class Service {
      static redirect(data) {
          this.dispatcher.trigger(new appCoreFramework.AxEvent(this, 'redirect', data));
      }
  }
  // 事件分发器
  Service.dispatcher = new appCoreFramework.AxDispatcher();
  ...
  function request$5(data) {
      ...
      return service$5.http('post', `api/json/App-Parking/${data.cmd}`, {}, JSON.stringify(data.args), {
          headers: ActorBase.mixinHeader({
              'Accept-Language': appCoreFramework.AxVuexApp.lang,
              'AX-Token': appCoreFramework.AxVuexUser.token,
  ...
  exports.ApiAppParking = ApiAppParking;
  exports.ApiBackstage = ApiBackstage;
  exports.ApiBizData = ApiBizData;
  exports.ApiCommon = ApiCommon;
  exports.ApiCore = ApiCore;
  exports.ApiDataSettings = ApiDataSettings;
  exports.ApiDataTenant = ApiDataTenant;
  exports.ApiDemo = ApiDemo;
  exports.ApiUpload = ApiUpload;
  exports.default = AxApi;
