...
var StorageUtils = /** @class */ (function () {
    ...
    StorageUtils.cookieRead = function (moduleName, key, defaultValue) {
        if (defaultValue === void 0) { defaultValue = null; }
        var value = Cookies.get(moduleName + '-' + key);
        if (!value)
            return defaultValue;
        return JSON.parse(value) || defaultValue;
    };
 ...
 * 应用数据模块
 */
var AppModule = getModule(AppState, store);
/**
 * 用户数据模块
 */
var UserModule = getModule(UserState, store);

export { BrowserUtils as AxBrowserUtils, index$3 as AxConfig, index$2 as AxConst, index$1 as AxCore, Dispatcher as AxDispatcher, DomUtils as AxDomUtils, EncryptionUtils as AxEncryptionUtils, IEvent as AxEvent, Language as AxLanguage, LanguageUtils as AxLanguageUtils, Locale as AxLocale, AxMenu, Request as AxRequest, StorageUtils as AxStorageUtils, StringUtils as AxStringUtils, StyleUtils as AxStyleUtils, ThemesUtils as AxThemesUtils, TransformUtils as AxTransformUtils, index as AxTypes, VueBase as AxVueBase, AppModule as AxVuexApp, UserModule as AxVuexUser, InitWebSocket as AxWebsocket };
