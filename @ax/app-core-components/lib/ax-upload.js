...
var upload_ = __webpack_require__(68);
...
var uploadvue_type_script_lang_ts_AxUpload = /*#__PURE__*/function (_AxComCore$AxUICompon) {
  Object(inherits["a" /* default */])(AxUpload, _AxComCore$AxUICompon);

  var _super = Object(createSuper["a" /* default */])(AxUpload);

  function AxUpload() {
    var _this;

    Object(classCallCheck["a" /* default */])(this, AxUpload);
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "text", void 0);
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "tip", void 0);

    return _this;
  }

  Object(createClass["a" /* default */])(AxUpload, [{
    key: "focus",
    value:
    /**
     * 获取焦点方法
...
uploadvue_type_script_lang_ts_AxUpload = Object(external_tslib_["__decorate"])([Object(external_vue_property_decorator_["Component"])({
  ...
  inheritAttrs: false,
  components: (_components = {}, Object(defineProperty["a" /* default */])(_components, upload_default.a.name, upload_default.a), Object(defineProperty["a" /* default */])(_components, "AxButton", ax_button_default.a), _components)
...
/* hot reload */
if (false) { var api; }
component.options.__file = "packages/ax-upload/src/upload.vue"
/* harmony default export */ var upload = (component.exports);
// CONCATENATED MODULE: ./packages/ax-upload/index.ts



Object(install["a" /* addInstall */])(upload.name, upload);
/* harmony default export */ var ax_upload = __webpack_exports__["default"] = (upload);
