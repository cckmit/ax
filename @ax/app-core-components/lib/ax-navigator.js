...
var navigatorvue_type_script_lang_ts_AxNavigator = /*#__PURE__*/function (_Vue) {
  Object(inherits["a" /* default */])(AxNavigator, _Vue);

  var _super = Object(createSuper["a" /* default */])(AxNavigator);

  function AxNavigator() {
    var _this;

    Object(classCallCheck["a" /* default */])(this, AxNavigator);
  ...
  Object(createClass["a" /* default */])(AxNavigator, [{
    key: "linkClick",
    value:
    /**
     * link模式下返回参数
...
/* hot reload */
if (false) { var api; }
component.options.__file = "packages/ax-navigator/src/navigator.vue"
/* harmony default export */ var src_navigator = (component.exports);
// CONCATENATED MODULE: ./packages/ax-navigator/index.ts



Object(install["a" /* addInstall */])(src_navigator.name, src_navigator);
/* harmony default export */ var ax_navigator = __webpack_exports__["default"] = (src_navigator);
