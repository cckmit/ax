...
var timevue_type_script_lang_ts_AxTime = /*#__PURE__*/function (_AxUIComponent) {
  Object(inherits["a" /* default */])(AxTime, _AxUIComponent);

  var _super = Object(createSuper["a" /* default */])(AxTime);

  function AxTime() {
    var _this;

    Object(classCallCheck["a" /* default */])(this, AxTime);
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "isRange", void 0);

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "editable", void 0);

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "arrowControl", void 0);
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "AxTimeType", ax_com_core_["AxTimeType"]);

    return _this;
  }

  Object(createClass["a" /* default */])(AxTime, [{
    key: "placeholderStr",
    get:
    /**
     * placeholder的显示
...
timevue_type_script_lang_ts_AxTime = Object(external_tslib_["__decorate"])([Object(external_vue_property_decorator_["Component"])({
  ...
  inheritAttrs: false,
  components: (_components = {}, Object(defineProperty["a" /* default */])(_components, time_picker_default.a.name, time_picker_default.a), Object(defineProperty["a" /* default */])(_components, time_select_default.a.name, time_select_default.a), _components)
...
/* hot reload */
if (false) { var api; }
component.options.__file = "packages/ax-time/src/time.vue"
/* harmony default export */ var time = (component.exports);
// CONCATENATED MODULE: ./packages/ax-time/index.ts



Object(install["a" /* addInstall */])(time.name, time);
/* harmony default export */ var ax_time = __webpack_exports__["default"] = (time);
