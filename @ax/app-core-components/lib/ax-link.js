...
var linkvue_type_script_lang_ts_AxLink = /*#__PURE__*/function (_Vue) {
  Object(inherits["a" /* default */])(AxLink, _Vue);

  var _super = Object(createSuper["a" /* default */])(AxLink);

  function AxLink() {
    var _this;

    Object(classCallCheck["a" /* default */])(this, AxLink);
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "refLink", void 0);
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "underline", void 0);

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "href", void 0);

    return _this;
  }

  Object(createClass["a" /* default */])(AxLink, [{
    key: "focus",
    value: //#endregion
    //#region 外部方法
...
Object(external_tslib_["__decorate"])([Object(external_vue_property_decorator_["Prop"])({
  default: ax_com_core_default.a.LinkType.DEFAULT
...
/* hot reload */
if (false) { var api; }
component.options.__file = "packages/ax-link/src/link.vue"
/* harmony default export */ var src_link = (component.exports);
// CONCATENATED MODULE: ./packages/ax-link/index.ts



Object(install["a" /* addInstall */])(src_link.name, src_link);
/* harmony default export */ var ax_link = __webpack_exports__["default"] = (src_link);
