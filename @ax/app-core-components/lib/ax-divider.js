...
var dividervue_type_script_lang_ts_AxDivider = /*#__PURE__*/function (_Vue) {
  Object(inherits["a" /* default */])(AxDivider, _Vue);

  var _super = Object(createSuper["a" /* default */])(AxDivider);

  function AxDivider() {
    var _this;

    Object(classCallCheck["a" /* default */])(this, AxDivider);
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "preset", void 0);

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "background", void 0);
  ...
  Object(createClass["a" /* default */])(AxDivider, [{
    key: "style",
    get: function get() {
      var style = {
      ...
      if (this.preset) {
        switch (this.preset) {
          case ax_com_core_default.a.DividerPreset.BUTTON:
            style.height = '2rem';
            break;
...
Object(external_tslib_["__decorate"])([Object(external_vue_property_decorator_["Prop"])({
  default: ax_com_core_default.a.DividerType.VERTICAL,
  type: String
...
/* hot reload */
if (false) { var api; }
component.options.__file = "packages/ax-divider/src/divider.vue"
/* harmony default export */ var divider = (component.exports);
// CONCATENATED MODULE: ./packages/ax-divider/index.ts



Object(install["a" /* addInstall */])(divider.name, divider);
/* harmony default export */ var ax_divider = __webpack_exports__["default"] = (divider);
