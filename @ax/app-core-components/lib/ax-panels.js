...
var panelsvue_type_script_lang_ts_AxPanels = /*#__PURE__*/function (_Vue) {
  Object(inherits["a" /* default */])(AxPanels, _Vue);

  var _super = Object(createSuper["a" /* default */])(AxPanels);

  function AxPanels() {
    var _this;

    Object(classCallCheck["a" /* default */])(this, AxPanels);
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "views", new Map());

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "current", undefined);
  ...
  Object(createClass["a" /* default */])(AxPanels, [{
    key: "watchCurrentTab",
...
/* hot reload */
if (false) { var api; }
component.options.__file = "packages/ax-panels/src/panels.vue"
/* harmony default export */ var panels = (component.exports);
// CONCATENATED MODULE: ./packages/ax-panels/index.ts



Object(install["a" /* addInstall */])(panels.name, panels);
/* harmony default export */ var ax_panels = __webpack_exports__["default"] = (panels);
