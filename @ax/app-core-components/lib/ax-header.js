...
var headervue_type_script_lang_ts_AxHeader = /*#__PURE__*/function (_Vue) {
  Object(inherits["a" /* default */])(AxHeader, _Vue);

  var _super = Object(createSuper["a" /* default */])(AxHeader);

  function AxHeader() {
    var _this;

    Object(classCallCheck["a" /* default */])(this, AxHeader);
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "mode", void 0);

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "icon", void 0);

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "hideBack", void 0);

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "hideBorder", void 0);

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "bgColor", void 0);

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "width", void 0);

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "titleClick", void 0);

    return _this;
  }

  Object(createClass["a" /* default */])(AxHeader, [{
    key: "handleBack",
    value:
    /**
     * 点击返回按钮处理
    ...
    key: "titleClickable",
    get: function get() {
      if (this.mode === ax_com_core_default.a.HeaderMode.FIRST && this.titleClick === undefined) {
        return true;
      } else {
...
Object(external_tslib_["__decorate"])([Object(external_vue_property_decorator_["Prop"])({
  default: ax_com_core_default.a.HeaderMode.FIRST,
  type: String
...
/* hot reload */
if (false) { var api; }
component.options.__file = "packages/ax-header/src/header.vue"
/* harmony default export */ var header = (component.exports);
// CONCATENATED MODULE: ./packages/ax-header/index.ts



Object(install["a" /* addInstall */])(header.name, header);
/* harmony default export */ var ax_header = __webpack_exports__["default"] = (header);
