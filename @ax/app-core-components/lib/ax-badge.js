...
var badgevue_type_script_lang_ts_AxBadge = /*#__PURE__*/function (_Vue) {
  Object(inherits["a" /* default */])(AxBadge, _Vue);

  var _super = Object(createSuper["a" /* default */])(AxBadge);

  function AxBadge() {
    var _this;

    Object(classCallCheck["a" /* default */])(this, AxBadge);
    ...
    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "isDot", void 0);

    Object(defineProperty["a" /* default */])(Object(assertThisInitialized["a" /* default */])(_this), "hidden", void 0);

    return _this;
  }

  Object(createClass["a" /* default */])(AxBadge, [{
    key: "content",
    get:
    /**
     * 内容获取
...
Object(external_tslib_["__decorate"])([Object(external_vue_property_decorator_["Prop"])({
  default: ax_com_core_default.a.BadgeType.DANGER
...
/* hot reload */
if (false) { var api; }
component.options.__file = "packages/ax-badge/src/badge.vue"
/* harmony default export */ var badge = (component.exports);
// CONCATENATED MODULE: ./packages/ax-badge/index.ts



Object(install["a" /* addInstall */])(badge.name, badge);
/* harmony default export */ var ax_badge = __webpack_exports__["default"] = (badge);
